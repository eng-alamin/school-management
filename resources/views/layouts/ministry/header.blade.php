    ...
    <div class="topnav-right topnav-controls">
      ...
      <div class="topnav-dropdown-wrap">
        ...
        <div class="topnav-dropdown" id="profileDropdown" style="min-width:220px">
          ...
          <a href="{{ route('ministry.profile.overview') }}" class="pd-menu-item"><span class="material-icons-round">person</span> My Profile</a>
          <a href="{{ route('ministry.profile.setting') }}" class="pd-menu-item"><span class="material-icons-round">edit</span> Edit Profile</a>
