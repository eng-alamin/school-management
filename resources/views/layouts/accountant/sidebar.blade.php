<aside class="sidebar no-print" id="mainSidebar">
  ...
  <div class="sidebar-scroll">
    ...
    <ul>
      @can('institution.dashboard.view')
      <li class="nav1-item">
      ...
      @if(feature_enabled(\App\Support\Feature::INVENTORY_MODULE) && auth()->user()->hasAnyPermission([
          'institution.inventory_product.view', 'institution.inventory_store.view', 'institution.inventory_supplier.view',
          'institution.inventory_purchase.view', 'institution.inventory_sale.view',
      ]))
        <li class="nav1-item">
          ...
          <div class="nav2-collapse {{ str_contains(request()->url(), 'accountant/inventory/') == true ? 'show' : '' }}">
            <ul>
              @can('institution.inventory_product.view')
              ...
              @endcan
              @can('institution.inventory_store.view')
              ...
              @endcan
              @can('institution.inventory_supplier.view')
              ...
              @endcan
              @can('institution.inventory_purchase.view')
              ...
              @endcan
              @can('institution.inventory_sale.view')
      ...
      @if(auth()->user()->hasAnyPermission([
          'institution.student_accounting_fee_type.view', 'institution.student_accounting_fee_setup.view',
          'institution.student_accounting_fee_fine.view', 'institution.student_accounting_student_fine.view',
          'institution.student_accounting_fee_invoice.view',
      ]))
      <li class="nav1-item">
        ...
        <div class="nav2-collapse {{ str_contains(request()->url(), 'student-accounting') == true ? 'show' : '' }}">
          <ul>
            @can('institution.student_accounting_fee_type.view')
            ...
            @endcan
            @can('institution.student_accounting_fee_setup.view')
            ...
            @endcan
            @can('institution.student_accounting_fee_fine.view')
            ...
            @endcan
            @can('institution.student_accounting_student_fine.view')
            ...
            @endcan
            @can('institution.student_accounting_fee_invoice.view')
      ...
      @if(auth()->user()->hasAnyPermission([
          'institution.office_accounting_account.view', 'institution.office_accounting_deposit.view',
          'institution.office_accounting_expense.view', 'institution.office_accounting_transaction.view',
          'institution.office_accounting_head.view',
      ]))
      <li class="nav1-item">
        ...
        <div class="nav2-collapse {{ str_contains(request()->url(), 'accountant/office-accounting') == true ? 'show' : '' }}">
          <ul>
            @can('institution.office_accounting_account.view')
            ...
            @endcan
            @can('institution.office_accounting_deposit.view')
            ...
            @endcan
            @can('institution.office_accounting_expense.view')
            ...
            @endcan
            @can('institution.office_accounting_transaction.view')
            ...
            @endcan
            @can('institution.office_accounting_head.view')
      ...
      @if(auth()->user()->hasAnyPermission(['institution.salary_template.view', 'institution.salary_assign.view', 'institution.salary_payment.view', 'institution.salary_advance.view',]))
        <li class="nav1-item">
          ...
          <div class="nav2-collapse {{ str_contains(request()->url(), 'salary') == true ? 'show' : '' }}">
            <ul>
              @can('institution.salary_template.view')
              ...
              @endcan
              @can('institution.salary_assign.view')
              ...
              @endcan
              @can('institution.salary_payment.view')
              ...
              @endcan
              @can('institution.salary_advance.view')
      ...
      @can('institution.leave_application.view')
      <li class="nav1-item">
      ...
      @can('institution.notification.view')
      <li class="nav1-item">
