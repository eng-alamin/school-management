        ...
        <div class="form-section {{ $step == 4 ? '' : 'd-none' }}">
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <button type="button" class="btn btn-sm-tpl" wire:click="goToStep(2)">
...
/**
 * Fired when a design card is clicked. The PHP-side selectDesign() call
 * (wired via wire:click on the card) is the actual source of truth for
 * certificate_content — this JS handler just mirrors it into Summernote
 * immediately, so the visible editor doesn't wait for the network round-trip.
 */
