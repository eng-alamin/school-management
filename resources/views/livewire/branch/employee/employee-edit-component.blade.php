{{-- livewire/admin/employee/employee-edit-component.blade.php --}}
...
<div>
    ...
    <div class="card">
        ...
        <div class="form-footer">
            ...
            <button class="btn btn-primary" type="button" wire:click="update" wire:loading.attr="disabled" wire:target="update">
