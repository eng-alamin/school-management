<div>
    ...
    <div class="card">
        ...
        <div class="form-section">
            ...
            <div class="row g-4 mt-2" wire:key="schedule-row-{{ $index }}">
                ...
                <div class="col-md-2">
                    <div class="input-group input-group-outline">
                        ...
                        <select wire:model.live="data.{{ $index }}.subject_id" class="form-select no-custom-select">
                    ...
                    @error('data.'.$index.'.subject_id') <span class="text-danger small">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="col-md-2">
                    <div class="input-group input-group-outline">
                        ...
                        <select wire:model="data.{{ $index }}.teacher_id" class="form-select no-custom-select">
                    ...
                    @error('data.'.$index.'.teacher_id') <span class="text-danger small">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="col-md-2 d-flex align-items-center">
                    @if(count($data) > 1)
                        <button type="button" wire:click="removeRow({{ $index }})" class="btn btn-primary">
            ...
            <div class="mt-4">
                <button type="button" wire:click="addRow" class="btn btn-primary">
