{{-- resources/views/livewire/branch/dashboard-component.blade.php --}}
...
<div class="dash-wrap">
    ...
    <div class="dash-header px-3 pt-3 pb-2">
        <h5 class="fw-bold mb-0 text-dark">Welcome, {{ auth()->user()->name }}! 👋</h5>
        ...
        <div class="row g-3">
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendFeeCollected])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendFeeToday])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendFeeDue])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendStudents])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendStaffs])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendTeachers])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendAttendance, 'suffix' => ' pts'])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendAdmissions])
                </div>
            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="dash-stat-card">
                    ...
                    @include('livewire.branch.dashboard-trend-badge', ['trend' => $trendHomework])
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('branch.notices') }}" class="btn btn-light">
