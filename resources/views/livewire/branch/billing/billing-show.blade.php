<div>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <div style="font-size:1.4rem;font-weight:700;color:var(--dark);margin-top:4px;">
                            ৳ {{ number_format($estimatedBill, 0) }}
                        </div>
                        <small class="text-muted d-block">
                            {{ number_format($activeStudentCount) }} active students × ৳{{ number_format($studentRate, 0) }}/student
                            = ৳ {{ number_format($studentAmount, 0) }}
                        </small>
                        <small class="text-muted d-block">
                            {{ number_format($smsCount) }} SMS sent × ৳{{ number_format($smsRate, 0) }}/SMS
                            = ৳ {{ number_format($smsAmount, 0) }}
                        </small>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @php($meta = \App\Models\Invoice::statusMeta($invoice->status))
                        <tr>
                            ...
                            <td>
                                <span class="badge rounded-pill {{ $meta['badge'] }}" style="font-size:.72rem;">
                                    {{ $meta['label'] }}
                                </span>
                            </td>
    ...
    @if($showDetailModal && $viewInvoice)
        @php($modalMeta = \App\Models\Invoice::statusMeta($viewInvoice->status))
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div style="border-left:4px solid {{ $modalMeta['hex'] }};padding:12px 16px;background:#f8f9fa;border-radius:0 8px 8px 0;margin-bottom:16px;">
                            <div style="font-size:.7rem;font-weight:600;color:{{ $modalMeta['hex'] }};text-transform:uppercase;letter-spacing:.05em;">
                                {{ $modalMeta['label'] }}
                            </div>
