                    ...
                    <tbody>
                        ...
                        <tr wire:key="mapping-{{ $mapping->id }}">
                            ...
                            <td class="text-muted small">
                                {{ $mapping->biometricDevice?->device_name ?? '—' }}
                            </td>
                            ...
                            <td>
                                ...
                                @else
                                    ...
                                    <span class="badge bg-success-subtle text-success">{{ $mapping->attendable?->academicClass?->name }}</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5 text-muted">
                                ...
                                <span data-en="No mappings found." data-bn="কোনো mapping পাওয়া যায়নি।">কোনো mapping পাওয়া যায়নি।</span>
                                <a wire:navigate href="{{ route($routePrefix . 'biometric.mapping.create', $selectedDeviceId !== '' ? ['device_id' => $selectedDeviceId] : []) }}"
