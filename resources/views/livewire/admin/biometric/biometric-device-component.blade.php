            ...
            <div class="card-toolbar">
                ...
                <div class="card-toolbar-title">
                    ...
                    <div style="position:relative;display:inline-flex;align-items:center">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" id="tableSearch" placeholder="Search name or serial" style="border:1px solid rgba(0,0,0,.1);border-radius:8px;padding:7px 12px 7px 32px;font-size:.78rem;font-family:inherit;color:var(--dark);outline:none;background:#f8f9fa;width:220px"/>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" wire:click="openEditModal({{ $viewingDevice->id }}); $set('showViewModal',false)">
                            <span class="material-icons-round me-1" style="font-size:.9rem;vertical-align:middle;">edit</span>Edit
                        </button>
                    </div>
                </div>
            </div>
...
@push('styles')
    <style>
        ...
        .device-avatar-active   { background: rgba(34,197,94,.12);  color: #16a34a; }
        .device-avatar-inactive { background: rgba(107,114,128,.12); color: #6b7280; }
