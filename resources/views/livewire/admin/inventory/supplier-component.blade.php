            ...
            <div class="card-toolbar">
                ...
                <div class="card-toolbar-title">
                    <div style="position:relative;display:inline-flex;align-items:center">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" id="inventory-supplier-search" placeholder="Search" class="tb-search"/>
                    </div>
                </div>
                ...
                <button class="btn btn-primary" wire:click="openCreate">
                    <span>
                        ...
                        <span id="inventory-supplier-add-btn">Add Supplier</span>
                    </span>
                </button>
