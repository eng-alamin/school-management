{{-- resources/views/livewire/admin/report/attendance-exam-report-component.blade.php --}}
<div>
    ...
    <div class="card">
        ...
        <div class="mat-card-header header-primary-gradient">
            <h5 id="cardHeaderTitleAllsections">Exam Attendance Report</h5>
            <p id="cardHeaderSubtitle">Exam অনুযায়ী student attendance filter করে দেখুন।</p>
        </div>
            ...
            <div class="card-toolbar flex-wrap mb-2">
                ...
                <div class="col-md-2">
                    <div class="input-group input-group-outline" wire:ignore>
                        ...
                        <select class="form-select form-select-sm" wire:model.live="examId">
                ...
                <div class="col-md-2">
                    <div class="input-group input-group-outline" wire:ignore>
                        ...
                        <select class="form-select form-select-sm" wire:model.live="subjectId">
                ...
                <div class="col-md-2">
                    ...
                    <div style="position:relative;display:inline-flex;align-items:center;width:100%">
                        ...
                        <input type="text" wire:model.live.debounce.400ms="search" placeholder="নাম / ID / Roll..." class="form-control form-control-sm" style="padding-left:32px;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="att-exam-{{ $record->id }}">
                        ...
                        <tr>
                            <td colspan="11" class="text-center py-5 text-muted">
                                ...
                                কোনো exam attendance record পাওয়া যায়নি।
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
