{{-- resources/views/livewire/admin/report/attendance-student-report-component.blade.php --}}
<div>
    ...
    <div class="card">
        ...
        <div class="mat-card-header header-primary-gradient">
            <h5 id="cardHeaderTitleAllsections">Student Attendance Report</h5>
            <p id="cardHeaderSubtitle">Student attendance (biometric + manual) filter করে দেখুন।</p>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="att-student-{{ $record->id }}">
