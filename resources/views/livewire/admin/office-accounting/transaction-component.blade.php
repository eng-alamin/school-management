        ...
        <div class="card-header border-0">
            <div class="card-toolbar flex-wrap gap-2">
                ...
                @if($filterDateFrom || $filterDateTo)
                    <button type="button" class="btn btn-sm btn-outline-secondary no-print" wire:click="clearDateFilter" title="Clear date filter">
                ...
                {{-- Print --}}
                <button type="button" class="btn btn-sm btn-pink no-print ms-auto" onclick="printTransactions()">
