    ...
    <div class="card">
        ...
        <div class="form-section">
            ...
            <div class="row g-4">
                ...
                {{-- ── Clickable Placeholder List (changes with Applicable For) ── --}}
                <div class="col-12">
                    @php
                        $placeholders = match($applicable_user) {
                            'student' => [
                                '{institute_name}', '{institute_email}', '{institute_mobile}', '{institute_address}',
                                '{session_year}', '{admission_date}', '{student_id}', '{registration_no}',
                                '{photo}', '{name}', '{class}', '{section}', '{group}', '{roll}',
                                '{gender}', '{blood}', '{birthday}', '{religion}',
                            ],
                            'employee' => [
                                '{institute_name}', '{institute_email}', '{institute_mobile}', '{institute_address}',
                                '{joining_date}', '{employee_id}', '{photo}', '{name}', '{designation}', '{department}',
                                '{gender}', '{blood}', '{birthday}', '{religion}', '{qualification}',
                    ...
                    <div class="placeholder-box mb-3">
                        <small class="d-block mb-2" style="color:#9ca3af;font-weight:600">
                            <span class="material-icons-round" style="font-size:14px;vertical-align:middle">touch_app</span>
                            Click a placeholder to insert it into the content below
                        </small>
                        ...
                        @else
                            <span class="text-muted small">Please select "Applicable For" (Student / Employee) above to see available placeholders.</span>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="photo-upload-box" onclick="document.getElementById('logoUpload').click()">
                        ...
                        @elseif($template->logo_image)
                            <img src="{{ asset($template->logo_image) }}" alt="Current Logo" style="max-height:60px;max-width:100%;object-fit:contain">
                ...
                <div class="col-md-4">
                    ...
                    <div class="photo-upload-box" onclick="document.getElementById('signatureUpload').click()">
                        ...
                        @elseif($template->signature_image)
                            <img src="{{ asset($template->signature_image) }}" alt="Current Signature" style="max-height:60px;max-width:100%;object-fit:contain">
                ...
                <div class="col-md-4">
                    ...
                    <div class="photo-upload-box" onclick="document.getElementById('backgroundUpload').click()">
                        ...
                        @elseif($template->background_image)
                            <img src="{{ asset($template->background_image) }}" alt="Current Background" style="max-height:60px;max-width:100%;object-fit:contain">
