<div>
    <div class="card">
        ...
        <div class="form-footer">
            <button class="btn btn-secondary" type="button" wire:click="skipPayment" wire:loading.attr="disabled" wire:target="skipPayment,confirmPayment">
                {{ $createdInvoiceDue <= 0 ? 'Back' : 'Skip / Later' }}
            </button>

            @if($createdInvoiceDue > 0)
                <button class="btn btn-primary" type="button" wire:click="confirmPayment" wire:loading.attr="disabled" wire:target="confirmPayment,skipPayment">
