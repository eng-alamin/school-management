            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="mat-card" style="padding:20px">
                        ...
                        <button type="button"wire:click="addAllowanceRow" class="btn btn-primary mt-2">
                            <span>
                ...
                <div class="col-md-6 d-flex flex-column gap-4">
                    ...
                    <div class="mat-card" style="padding:20px">
                        ...
                        <button type="button" wire:click="addDeductionRow" class="btn btn-primary mt-2">
                            <span>
                                <span class="material-icons-round" style="font-size:16px">add_circle</span>
                                <span> Add Rows</span>
                            </span>
        ...
        <div class="form-footer">
            ...
            <button class="btn btn-primary"
                ...
                <span wire:loading wire:target="save">
                    <span class="material-icons-round" style="animation:spin .7s linear infinite">
                        sync
                    </span>
                   <span> Saving...</span>
                </span>
