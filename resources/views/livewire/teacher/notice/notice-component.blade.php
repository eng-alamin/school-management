{{-- resources/views/livewire/teacher/notice/notice-component.blade.php --}}
<div>
    ...
    <div class="card">
        ...
        <div class="mat-card-header header-pink-gradient">
            ...
            <p id="cardHeaderSubtitle">Manage and publish notices for students, teachers, and teachers.</p>
        </div>
