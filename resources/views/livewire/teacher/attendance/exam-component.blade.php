<div>
    <div class="card">
        ...
        @if($exams->isEmpty())
            {{-- Ekhono kono exam invigilator duty assign kora hoyni --}}
            <div class="form-section" style="padding-top:40px; padding-bottom:20px">
                <div class="text-center py-5 text-muted">
                    ...
                    No exam invigilator duty has been assigned to you yet.<br>
                    <small>Please contact your admin for an exam duty assignment.</small>
                </div>
            </div>
        @else
        {{-- Select Ground --}}
        <div class="form-section" style="padding-top:40px; padding-bottom:20px">
            ...
            <div class="row g-4">
                ...
                {{-- Exam (shudhu amake assign kora exam-gulo dekhabe) --}}
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="input-group input-group-outline">
                        ...
                        <select wire:model.live="filterClass" class="form-select" {{ !$filterExam ? 'disabled' : '' }}>
                            <option value="">{{ !$filterExam ? 'Select Exam First' : 'Select Class' }}</option>
                ...
                <div class="col-md-3">
                    <div wire:ignore.self class="input-group input-group-outline">
                        ...
                        <select wire:model.live="filterSection" class="form-select" {{ $sections->isEmpty() ? 'disabled' : '' }}>
                            <option value="">{{ !$filterClass ? 'Select Class First' : ($sections->isEmpty() ? 'No Section' : 'Select Section') }}</option>
                            @if($sections->isNotEmpty())
                                <option value="all">All My Assigned Sections</option>
                ...
                {{-- Subject (shudhu amake assign kora subject-gulo dekhabe) --}}
                <div class="col-md-3">
                    <div wire:ignore.self class="input-group input-group-outline">
                        <label class="form-label">Subject</label>
                        <select wire:model="filterSubject" class="form-select" {{ empty($subjects) ? 'disabled' : '' }}>
                            <option value="">{{ empty($subjects) ? 'No Subject' : 'Select Subject' }}</option>
