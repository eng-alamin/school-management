<div class="card-custom profile-card p-4 mb-4">
    ...
    <ul class="nav profile-tabs border-bottom mt-4 flex-nowrap overflow-auto">
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('accountant.parent.overview') ? 'active' : '' }}" href="{{ route('accountant.parent.overview', ['id' => $parent->id]) }}">Overview</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('accountant.parent.child') ? 'active' : '' }}" href="{{ route('accountant.parent.child', ['id' => $parent->id]) }}">Children</a></li>
