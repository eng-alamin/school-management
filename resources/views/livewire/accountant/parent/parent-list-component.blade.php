    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <a href="{{ route('accountant.parent.add') }}" class="btn-outline bg-dark text-white">
                        ...
                        <tr>
                            ...
                            <td class="no-print">
                                <div class="d-flex gap-1">
                                    <a href="{{ route('accountant.parent.overview', ['id' => $parent->id]) }}" target="_blank"
                                        class="act-btn view" title="View">
                                        <span class="material-icons-round">visibility</span>
                                    </a>
                                    <a href="{{ route('accountant.parent.edit', ['id' => $parent->id]) }}" target="_blank"
