    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <a href="{{ route('accountant.event.types') }}" class="btn-sm btn-outline bg-dark text-white">
                    <span class="material-icons-round">add</span> Add Types
                </a>
                <a href="{{ route('accountant.event.add') }}" class="btn-sm btn-outline bg-dark text-white">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('accountant.event.edit', ['id' => $event->id]) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-5 text-muted">
                                    ...
                                    No events found.
                                    <a href="{{ route('accountant.event.add') }}">Create one now</a>.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
