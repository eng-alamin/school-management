<div class="card profile-card p-4 mb-4">
        ...
        <div class="flex-grow-1">
            ...
            <div class="d-flex flex-wrap align-items-center gap-3 mt-3">
                <div class="stat-box">
                    ...
                    <div class="stat-label" data-en="Role" data-bn="রোল">Role</div>
                </div>
                <div class="stat-box">
                    <div class="d-flex align-items-center gap-1">
                    ...
                    <div class="stat-label" data-en="Joined" data-bn="যোগদান">Joined</div>
                </div>
                <div class="stat-box">
                    <div class="d-flex align-items-center gap-1">
                    ...
                    <div class="stat-label" data-en="Last Active" data-bn="সর্বশেষ সক্রিয়">Last Active</div>
                </div>
            </div>
    ...
    <ul class="nav profile-tabs border-bottom mt-4 flex-nowrap overflow-auto">
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('superadmin.profile.overview') ? 'active' : '' }}" href="{{ route('superadmin.profile.overview') }}" data-en="Overview" data-bn="ওভারভিউ">Overview</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('superadmin.profile.setting') ? 'active' : '' }}" href="{{ route('superadmin.profile.setting') }}" data-en="Settings" data-bn="সেটিংস">Settings</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('superadmin.profile.loginlog') ? 'active' : '' }}" href="{{ route('superadmin.profile.loginlog') }}" data-en="Login Logs" data-bn="লগইন লগ">Login Logs </a></li>
    </ul>
</div>