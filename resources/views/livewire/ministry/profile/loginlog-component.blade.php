<div>
    <div class="card">
        ...
        <div class="mat-card-header header-primary-gradient">
            <h5 id="cardHeaderTitleProfileActivity" data-en="Profile Activity" data-bn="প্রোফাইল অ্যাক্টিভিটি">Profile Activity</h5>
        </div>
        ...
        <div class="container-xl mt-4">
            ...
            <div class="card profile-card p-4 mb-4">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                    <div>
                        <span class="fw-bold fs-5" data-en="Active Sessions" data-bn="সক্রিয় সেশন">Active Sessions</span>
                        <div class="text-muted mt-1" style="font-size:.8rem" data-en="Devices currently logged in to your account" data-bn="আপনার অ্যাকাউন্টে বর্তমানে লগইন থাকা ডিভাইসসমূহ">
                    ...
                    @if($sessions->where('is_current', false)->count() > 0)
                        <button wire:click="revokeAllOther"
                            ...
                            <span data-en="Revoke All Others" data-bn="বাকি সব বাতিল করুন">Revoke All Others</span>
                        </button>
                    @endif
                </div>
                    ...
                    <div class="d-flex align-items-start gap-3 py-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                            ...
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                @if($session->is_current)
                                    <span class="badge rounded-pill"
                                          ...
                                          data-en="Current" data-bn="বর্তমান">
                                        Current
                                    </span>
                                @endif
                            </div>
                        ...
                        @if(! $session->is_current)
                            <button wire:click="revokeSession('{{ $session->id }}')"
                                ...
                                <span data-en="Revoke" data-bn="বাতিল করুন">Revoke</span>
                            </button>
                        @endif
                ...
                @empty
                    <div class="text-center py-5 text-muted">
                        ...
                        <span data-en="No active sessions found." data-bn="কোনো সক্রিয় সেশন পাওয়া যায়নি।">No active sessions found.</span>
                    </div>
                @endforelse
