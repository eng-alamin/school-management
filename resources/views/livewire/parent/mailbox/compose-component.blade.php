{{-- resources/views/livewire/parent/mailbox/compose-component.blade.php --}}
<div class="mailbox-wrapper">
    @include('livewire.parent.mailbox.partials.sidebar')
    ...
    <div class="mailbox-content">
        ...
        <div class="compose-form-card">
            ...
            <div class="compose-actions">
                ...
                <a href="{{ route('parent.mailbox.inbox') }}" class="btn btn-light rounded-pill ms-2">
...
@include('livewire.parent.mailbox.partials.styles')