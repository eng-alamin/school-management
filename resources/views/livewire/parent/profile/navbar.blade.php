<div class="card-custom profile-card p-4 mb-4">
    ...
    <ul class="nav profile-tabs border-bottom mt-4 flex-nowrap overflow-auto">
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('parent.profile.overview') ? 'active' : '' }}" href="{{ route('parent.profile.overview') }}">Overview</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('parent.profile.setting') ? 'active' : '' }}" href="{{ route('parent.profile.setting') }}">Settings</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('parent.profile.loginlog') ? 'active' : '' }}" href="{{ route('parent.profile.loginlog') }}">Login Logs </a></li>
    </ul>
</div>