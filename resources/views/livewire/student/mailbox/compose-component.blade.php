{{-- resources/views/livewire/student/mailbox/compose-component.blade.php --}}
<div class="mailbox-wrapper">
    @include('livewire.student.mailbox.partials.sidebar')
    ...
    <div class="mailbox-content">
        ...
        <div class="compose-form-card">
            ...
            <div class="compose-actions">
                ...
                <a href="{{ route('student.mailbox.inbox') }}" class="btn btn-light rounded-pill ms-2">
...
@include('livewire.student.mailbox.partials.styles')