<div class="card-custom profile-card p-4 mb-4">
    ...
    <ul class="nav profile-tabs border-bottom mt-4 flex-nowrap overflow-auto">
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('student.profile.overview') ? 'active' : '' }}" href="{{ route('student.profile.overview') }}">Overview</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('student.profile.setting') ? 'active' : '' }}" href="{{ route('student.profile.setting') }}">Settings</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('student.profile.loginlog') ? 'active' : '' }}" href="{{ route('student.profile.loginlog') }}">Login Logs </a></li>
    </ul>
</div>