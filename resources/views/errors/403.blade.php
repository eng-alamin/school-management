    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon-wrap {
            ...
            height: 110px;
            margin: 0 auto 24px;
            background: linear-gradient(135deg, #ff5f6d, #ff8f5f);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
    ...
    <div class="error-page">
        <div class="icon-wrap">
            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-12V7a4 4 0 10-8 0v2h8z"/>
            </svg>
        </div>
        <div class="code">403</div>
        <div class="title">প্রবেশাধিকার নেই</div>
        <p class="message">দুঃখিত, আপনি এই পেজটি দেখার অনুমতি পাচ্ছেন না। এটি সীমাবদ্ধ এলাকা অথবা আপনার প্রয়োজনীয় পারমিশন নেই।</p>
