    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-home {
            ...
            padding: 14px 32px;
            border-radius: 50px;
            box-shadow: 0 10px 24px rgba(247, 151, 30, 0.35);
            transition: transform 0.25s ease, box-shadow 0.25s ease;
        }

        .btn-home:hover {
            transform: translateY(-3px);
            box-shadow: 0 14px 30px rgba(247, 151, 30, 0.45);
        }
...
<body>
    <div class="error-page">
        ...
        <div class="title">সেশনের মেয়াদ শেষ</div>
        <p class="message">দুঃখিত, আপনার সেশনের মেয়াদ শেষ হয়ে গেছে। নিরাপত্তার জন্য অনুগ্রহ করে আবার লগইন করুন।</p>
