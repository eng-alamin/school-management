...
namespace App\Livewire\ITSupport\Event;
...
class TypeComponent extends Component
{
    ...
    {
        // BUG FIX (Security/IDOR): scoped by institution_id so an admin
        // cannot open another institution's event type by guessing the ID.
