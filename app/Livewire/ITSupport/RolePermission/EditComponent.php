...
namespace App\Livewire\ITSupport\RolePermission;
...
use App\Livewire\ITSupport\RolePermission\Concerns\InteractsWithPermissionMatrix;
...
class EditComponent extends Component
{
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $this->redirectRoute('itsupport.role-permission.index', navigate: true);
