...
namespace App\Livewire\Branch\OfficeAccounting;
...
class ExpenseEditComponent extends Component
{
    ...
    public function update()
    {
        ...
        try {
            ...
            activity()
                ->performedOn($this->expense)
                ->withProperties(['institution_id' => institution()->id])
                ->log('Office Expense Updated');
            ...
            $this->redirect(route('branch.office-accounting.expense.list'), navigate: true);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.office-accounting.expense-edit-component')
