...
class DashboardComponent extends Component
{
     ...
     *
     * BRANCH SCOPING NOTE: এই dashboard Branch role panel-এর জন্য। সব ডাটা raw
     * DB::table() query দিয়ে আসছে, তাই Eloquent-এর BranchScope global scope এখানে
     * কাজ করে না — প্রতিটা branch-scoped টেবিলে explicit where('branch_id', ...)
     * বসানো হয়েছে buildDashboardData()-তে, defense-in-depth হিসেবে।
     */
    private function loadDashboardData(): void
    {
        ...
        // Cache key-তে branchId অবশ্যই থাকতে হবে — নাহলে একই institution-এর
        // ভিন্ন branch-এর user একে অপরের cached dashboard ডাটা দেখে ফেলবে।
        $data = Cache::remember(
            "branch_dashboard:{$institutionId}:{$branchId}",
            now()->addMinutes(5),
     ...
     * institution_id + branch_id scope defense-in-depth হিসেবে explicit রাখা হলো,
    ...
    private function buildDashboardData(int $institutionId, ?int $branchId): array
    {
        ...
        // ── Current Session (institution-level, branch দিয়ে scope হয় না) ────
        ...
        // ── Notices & Messages ─────────────────────────────────────────────
        // notices.branch_id nullable — institution-wide notice (null) অথবা এই
        // branch-এর notice, দুটোই branch dashboard-এ দেখানো হবে।
        ...
        // ── Recent Notices (institution-wide + এই branch-এর) ─────────────────
        ...
        // ── Recent Messages (ব্যবহারকারী-ভিত্তিক, branch scope দরকার নেই) ─────
        ...
        // ── Recent Activities (institution-level log) ──────────────────────
    ...
    public function render()
    {
        ...
        return view('livewire.branch.dashboard-component', [
